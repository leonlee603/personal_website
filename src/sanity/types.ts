...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Topic | Article | Post | Author | Category | Slug | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Code;
...
export type POSTS_RANGE_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  body: Array<{
...
// Variable: POSTS_IN_CATEGORY_QUERY
// Query: *[_type == "post" && defined(slug.current) && $category in categories[]->slug.current] | order(publishedAt desc) {    _id,    title,    slug,    body,    mainImage,    publishedAt,    "categories": coalesce(      categories[]->{        _id,        slug,        title      },      []    ),    author->{      name,      image    }}
export type POSTS_IN_CATEGORY_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  body: Array<{
...
// Variable: POSTS_IN_CATEGORY_RANGE_QUERY
...
export type POSTS_IN_CATEGORY_RANGE_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  body: Array<{
